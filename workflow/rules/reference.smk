...
if config["ref"]["build"] == "hg38":
    ...
    rule get_dbsnp:
        ...
        shell:
            ...
            rm {params.output_dir}/{params.genome_build}/variation/dbsnp-$build-orig.vcf.gz
            rm {params.output_dir}/{params.genome_build}/variation/dbsnp-$build-orig.vcf.gz.tbi
            """
